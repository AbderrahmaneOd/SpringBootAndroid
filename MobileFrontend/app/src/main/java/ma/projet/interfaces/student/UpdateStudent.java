...
public class UpdateStudent extends AppCompatActivity {
    ...
    public void getStudent(String id){
        String getSUrl = "http://192.168.11.167:8080/api/student/"+id;
    ...
    private void getFilieres() {
        String getFUrl = "http://192.168.11.167:8080/api/filiere";
        requestQueue = Volley.newRequestQueue(getApplicationContext());
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET,
            ...
            public void onResponse(JSONArray response) {
                ...
                for (Filiere filiere : filieres) {
                    filiereMap.put(filiere.getNom(), filiere);
                }
    ...
    private void getRoles() {
        String getRolesUrl = "http://192.168.11.167:8080/api/role";
        requestQueue = Volley.newRequestQueue(getApplicationContext());
    ...
    private void showRolesDialog() {
        ...
        for (int i = 0; i < roles.size(); i++) {
            rolesArray[i] = roles.get(i).getNom();
        }
    ...
    public void submitStudent() {
        String insertUrl = "http://192.168.11.167:8080/api/student";
        ...
        try {
            ...
            filiereObject.put("nom", selectedFiliere.getNom());
    ...
    private void setFiliereAndRoles() {
        ...
        if (student.getRoles() != null && !student.getRoles().isEmpty()) {
            ...
            for (Role role : selectedRoles) {
                rolesStr.append(role.getNom()).append("   ");
            }
    ...
    public void deleteStudent(int id) {
        String deleteUrl = "http://192.168.11.167:8080/api/student/" + id;
        requestQueue = Volley.newRequestQueue(getApplicationContext());
