...
public class UpdateRole extends AppCompatActivity {
    ...
    public void getRole(String id){
        String getUrl = "http://192.168.11.167:8080/api/role/"+id;
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET,
            ...
            public void onResponse(JSONObject response) {
                ...
                name.setText(role.getNom().toString());
    ...
    public void submitRole() {
        String insertUrl = "http://192.168.11.167:8080/api/role/"+id;
    ...
    public void deleteRole(String id) {
        String deleteUrl = "http://192.168.11.167:8080/api/role/" + id;
        requestQueue = Volley.newRequestQueue(getApplicationContext());
